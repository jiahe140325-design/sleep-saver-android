...
> 当前版本：`1.3.5-dev`。今日页、打卡页和睡眠手帐已完成第一轮「小手帐」风格迭代。这是正在验证中的个人项目，不是医疗设备，也不能代替专业睡眠诊断。
...
1. 前往 [拯救睡眠 1.3.5-dev 发布页](https://github.com/jiahe140325-design/sleep-saver-android/releases/tag/v1.3.5-dev)，展开 `Assets`，下载 `SleepSaver-1.3.5-dev.apk`。不要下载 `Source code` 压缩包。
...
以下截图来自 `1.2.2-dev` 在小米 14 Pro 上的早期实际安装效果，用于保留项目迭代起点，不代表 `1.3.5-dev` 的当前界面。
