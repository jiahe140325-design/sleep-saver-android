...
- 小米 14 Pro 真机：用户已确认 `1.2.0-dev` 可手动安装并打开；`1.2.2-dev` 原创玩偶图标更新包待覆盖安装。17 个完整真机场景仍按表格保留为待验证，不用安装成功代替功能验收。

## 2. 产物

- APK：`app/build/outputs/apk/debug/app-debug.apk`
- 文件大小：64,896,619 bytes（约 61.9 MiB，debug 测试包未做发布压缩）
- SHA-256：`b17fbc360d34b7979dc348f54631aad77c185208f20842978393b17cb98cb48b`
...
2. 安装 debug APK，首次打开应用。
   - 成功标志：出现「拯救睡眠」今日页，底部有今日、打卡、手帐、好友四项。
